		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comapplexuscommutecompanion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexuscommutecompanion-display": {
								"semanticObject": "comapplexuscommutecompanion",
								"action": "display",
								"description": "Commute Companion-A Car Sharing Platform For Applexus",
								"title": "Commute Companion",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.commutecompanion",
									"url": sap.ui.require.toUrl("com/applexus/commutecompanion")
								}
							}
						}
					}
